   ...
   function setWeight(node) {
    ...
    async function runAStar() {  
     ...
     async function runBreadthFirst() {
        ...
        const {nodesVisited, breadthFirstLength} = await breadthFirst(startNode, endNode, nodes, props.sliderValue) 
        setPathLength(breadthFirstLength)
    ...
    return (
        <div>
            <NavBar 
                ...
                runBreadthFirst={runBreadthFirst}
